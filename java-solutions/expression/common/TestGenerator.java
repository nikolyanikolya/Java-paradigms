...
public class TestGenerator<C> {
    ...
    public <E> void testBasic(final ExpressionKind.Variables<E> variables, final Consumer<Test<C, E>> consumer) {
...
//                counter.println(full.render(Expr.of(node, vars)));
    ...
    public <E> void testRandom(final int denominator, final ExpressionKind.Variables<E> variables, final Consumer<Test<C, E>> consumer) {
    ...
    public <E extends ToMiniString> List<Pair<String,E>> variables(final ExpressionKind.Variables<E> variables, final int count) {
